...
def score_log(model, text):
    ...
    Args:
        model (kenlm.Model): Preloaded KenLM language model (e.g., 2-gram, 3-gram, 4-gram or 5-gram).
        text (str): Sentence or passage to be scored.

    Returns:
        float: Log-probability score (base e).
    """
...
def calculate_entropy(ngrams):
    ...
    probs = [v / total for v in count.values()] #convert raw frequencies to probilities
    return calc_entropy(probs) #compute and return entropy using scipy entropy function

#Frequency_Variance
def frequency_variance(ngrams):
    count = Counter(ngrams)
    values = list(count.values()) #Extract the frequncy count as a list
    return np.var(values) if len(values) > 1 else 0 #if there are more than 1 unique n-gram, compute vaqriance otherwise return 0, variance measure how much n-gram frequncy differ from each other.
...
def batch_process_hc3():
    base_path = "."  
    output_dir = "../hc3_output"
    os.makedirs(output_dir, exist_ok=True)

    hc3_files = {
        0.1: "hc3_gpt-4.raw_data_variants_gpt4_temp0.1.csv",
        0.3: "hc3_gpt-4.raw_data_variants_gpt4_temp0.3.csv",
        0.5: "hc3_gpt-4.raw_data_variants_gpt4_temp0.5.csv",
        0.7: "hc3_gpt-4.raw_data_variants_gpt4_temp0.7.csv",
        0.9: "hc3_gpt-4.raw_data_variants_gpt4_temp0.9.csv",
        1.1: "hc3_gpt-4.raw_data_variants_gpt4_temp1.1.csv",
    }
...
def batch_process_pubmed():
    ...
    output_dir = "../pubmed_output"
    os.makedirs(output_dir, exist_ok=True)

    pubmed_files = {
        0.1: "pubmed_gpt-4.raw_data_variants_gpt4_temp0.1.csv",
        0.3: "pubmed_gpt-4.raw_data_variants_gpt4_temp0.3.csv",
        0.5: "pubmed_gpt-4.raw_data_variants_gpt4_temp0.5.csv",
        0.7: "pubmed_gpt-4.raw_data_variants_gpt4_temp0.7.csv",
        0.9: "pubmed_gpt-4.raw_data_variants_gpt4_temp0.9.csv",
        1.1: "pubmed_gpt-4.raw_data_variants_gpt4_temp1.1.csv",
    }
...
def batch_process_writing():
    ...
    output_dir = "../writing_output"
    os.makedirs(output_dir, exist_ok=True)

    writing_files = {
        0.1: "writing_gpt-4.raw_data_variants_gpt4_temp0.1.csv",
        0.3: "writing_gpt-4.raw_data_variants_gpt4_temp0.3.csv",
        0.5: "writing_gpt-4.raw_data_variants_gpt4_temp0.5.csv",
        0.7: "writing_gpt-4.raw_data_variants_gpt4_temp0.7.csv",
        0.9: "writing_gpt-4.raw_data_variants_gpt4_temp0.9.csv",
        1.1: "writing_gpt-4.raw_data_variants_gpt4_temp1.1.csv",
    }
...
def batch_process_xsum():
    ...
    output_dir = "../xsum_output"
    os.makedirs(output_dir, exist_ok=True)

    xsum_files = {
        0.1: "xsum_gpt-4.raw_data_variants_gpt4_temp0.1.csv",
        0.3: "xsum_gpt-4.raw_data_variants_gpt4_temp0.3.csv",
        0.5: "xsum_gpt-4.raw_data_variants_gpt4_temp0.5.csv",
        0.7: "xsum_gpt-4.raw_data_variants_gpt4_temp0.7.csv",
        0.9: "xsum_gpt-4.raw_data_variants_gpt4_temp0.9.csv",
        1.1: "xsum_gpt-4.raw_data_variants_gpt4_temp1.1.csv",
    }
